 ...
 *
 * There is one set of certificates, not one per device. The phone course plays
 * the same lessons from `content/lessons/`, so finishing a unit on a phone earns
 * exactly the certificate finishing it on a laptop earns — and a second, phone-
 * branded copy of the same certificate would be telling the person who reads it
 * something that is not true about what was learned.
 */
