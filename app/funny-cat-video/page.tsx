    ...
    <div className="h-full overflow-y-auto bg-white">
      <div className="max-w-xl mx-auto px-6 py-8 space-y-4">
        ...
        <p className="text-sm text-gray-700 leading-relaxed">
          A local cat, known only as &quot;Whiskers&quot; by neighbours who have not been formally introduced, spent approximately forty-five minutes on a windowsill yesterday, studying a passing cyclist with an expression that implied serious reservations.
        </p>
        <p className="text-sm text-gray-700 leading-relaxed">
